...
public class ReminderController {
  ...
  @PutMapping("/update")
  public ResponseEntity<ReminderAccesDto> saveReminder(@RequestBody ReminderAccesDto reminderAccesDto)
      throws DataNotFoundException {
    return new ResponseEntity<>(reminderService.updateReminder(reminderAccesDto), HttpStatus.OK);
  }
}
